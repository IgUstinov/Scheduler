...
const { scheduleLogger, taskLogger, generatorLogger, createLogFormatter } = require('../src/logger/Logger');
    ...
    test('должен задавать формат и конфигурировать общий файл записи', () => {
        ...
        expect(mockLogger.transports).toEqual(
            expect.arrayContaining([
                expect.objectContaining({ filename: expect.stringContaining('app.log') }),
            ])
        );
    });
});
